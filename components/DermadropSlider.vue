<template>
  <section class="specialists-section">
    <h3 class="title-el title-el_block">
      Примеры процедуры Dermadrop: До/После
    </h3>
      ...
      <div class="specialists-slider" :style="{ transform: translateParam }">
        <div class="specialist-slide" :style="{ width: widthSlidePX }">
          <img
            preset="allimg"
            decoding="async"
            src="/images/new-balance/dermadrop/slider.png"
            alt="specialist"
          />
          <div class="desc-specialist_block">
            <div class="slider-title">Проблема:</div>
            <div class="slider-text">
              Сухость кожи, с которой не справляется домашний уход.
            </div>
            <div class="slider-title">Результат:</div>
            <div class="slider-text">
              Курс из 5 процедур Dermadrop с сывороткой HYAL + авторская
              методика для усиления и пролонгирования эффекта. Подобрали
              правильный домашний уход. Девушка всю осень и зиму не испытывала
              сухость кожи лица.
            </div>
          </div>
        </div>
