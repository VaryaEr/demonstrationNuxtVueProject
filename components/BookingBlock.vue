<template>
  <section class="section-form">
    <h3 class="specialists-title form-title">
      Начните путь к красоте и здоровью!
    </h3>
    <div class="form-block">
      ...
      <div class="specialist-block">
        <img
          preset="allimg"
          decoding="async"
          src="/images/3vrach-Yana-Komissarova1.png"
          alt="specialist"
        />
        <div class="specialist-name">Туманова Александра Александровна</div>
        <div class="specialist-role">Косметолог-эстетист</div>
        <div class="form-specialist_text">
          Мы работаем каждый день, чтобы Вы могли сохранить здоровье и молодость
